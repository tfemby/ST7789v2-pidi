...
class PiDiConfig:
    def __init__(self, config=None):
        ...
        self.spi_chip_select_pin = config.get("spi_chip_select_pin", 1)
        self.spi_data_command_pin = config.get("spi_data_command_pin", 9)
        self.spi_reset_pin = config.get("spi_reset_pin", 27)
        self.backlight_pin = config.get("backlight_pin", 13)
